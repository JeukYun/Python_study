...
print(xxx)  # [  1   2   3   4   5   6 100 200 300 400] # flatten 되어 추가

# 2) axis=0 지정한 추가 ==> 행 추가 , 반드시 shape 일치 필요!!!
...
# 2) axis=0 지정한 삽입 ==> 행 삽입, 반드시 shape 일치 !!!!
...
xxx = np.insert(arr, [0,1], [[100],[200]], axis=1)
print(xxx)
